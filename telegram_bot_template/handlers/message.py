...
class MessageHandler:
    ...
    def __init__(self, locale_manager: LocaleManager, keyboard_manager: KeyboardManager,
                 database: DatabaseManager, ai_provider: Optional[OpenRouterProvider], config):
    ...
    async def handle_text_message(self, update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
        ...
        try:
            ...
            user_data = await self.database.ensure_user(
                user_id=user.id,
            ...
            await message.reply_text(
                self.locale_manager.get("error_occurred", user_language)
            )
    
    async def _handle_ai_message(self, update: Update, user_message: str, 
                                user_language: str, user_id: int) -> None:
        ...
        try:
            ...
            processing_msg = await message.reply_text(
                self.locale_manager.get("processing", user_language),
                do_quote=True
            )
            
            # Get AI response
            system_prompt = self._get_system_prompt(user_language)
            ai_response = await self.ai_provider.get_response(
            ...
            # Send error message
            await message.reply_text(
                self.locale_manager.get("ai_not_available", user_language),
                do_quote=True
            )
    
    async def _handle_simple_echo(self, update: Update, user_message: str, 
    ...
    async def handle_photo(self, update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
        ...
        try:
            ...
            await message.reply_text(
                "📸 I received your photo! Unfortunately, I can't process images yet.",
                do_quote=True
            )
    ...
    async def handle_document(self, update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
        ...
        try:
            ...
            await message.reply_text(
                "📄 I received your document! Unfortunately, I can't process files yet.",
                do_quote=True
            )
    ...
    async def handle_voice(self, update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
        ...
        try:
            ...
            await message.reply_text(
                "🎤 I received your voice message! Unfortunately, I can't process audio yet.",
                do_quote=True
            )
