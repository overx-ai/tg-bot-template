...
class OpenRouterProvider:
    ...
    async def get_response(self, message: str, user_id: Optional[int] = None, 
        ...
        try:
            ...
            if system_prompt:
                ...
                messages.append({
                    "role": "system", 
                    "content": "You are a helpful assistant. Respond in a friendly and informative way."
                })
                ...
                async with session.post(
                    ...
                    if response.status == 200:
                        ...
                        if "choices" in data and len(data["choices"]) > 0:
                            ...
                            if "usage" in data:
                                usage = data["usage"]
                                logger.debug(f"OpenRouter usage - Prompt: {usage.get('prompt_tokens', 0)}, "
    ...
    async def get_streaming_response(self, message: str, user_id: Optional[int] = None,
