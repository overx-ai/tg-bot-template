...
class KeyboardManager:
        ...
        if cache_key not in self._keyboards_cache:
            keyboard = [
                [InlineKeyboardButton(
                    self.locale_manager.get("help", language),
                    callback_data="help"
                )],
                [InlineKeyboardButton(
                    self.locale_manager.get("about", language),
                    callback_data="about"
                )],
                [InlineKeyboardButton(
                    self.locale_manager.get("settings", language),
    ...
    def get_settings_keyboard(self, language: str = "en") -> InlineKeyboardMarkup:
        ...
        if cache_key not in self._keyboards_cache:
            keyboard = [
                [InlineKeyboardButton(
                    self.locale_manager.get("language", language),
                    callback_data="change_language"
                )],
                [InlineKeyboardButton(
                    self.locale_manager.get("back_to_menu", language),
    ...
    def get_language_selection_keyboard(self, current_language: str = "en") -> InlineKeyboardMarkup:
        ...
        # Add back button
        keyboard.append([InlineKeyboardButton(
            self.locale_manager.get("back_to_menu", current_language),
            callback_data="settings"
        )])
    ...
    def get_cache_info(self) -> Dict[str, int]:
        ...
        return {
            "cached_keyboards": len(self._keyboards_cache),
            "cache_keys": list(self._keyboards_cache.keys())
        }
    ...
    def add_back_button(self, keyboard: InlineKeyboardMarkup, language: str = "en", 
                       callback_data: str = "back_to_menu") -> InlineKeyboardMarkup:
